import { createIcons, Download, FilePlus, Copy, Trash2, Sparkles, SquareTerminal, Settings, X, SunMoon, Cpu } from 'lucide';
...
export function initIcons() {
  createIcons({
    icons: { Download, FilePlus, Copy, Trash2, Sparkles, SquareTerminal, Settings, X, SunMoon, Cpu },
  });
}
